...
class Librarian(Character.Character):
    ...
    def minigame(self,screen,t):
        ...
        titleList3 = ["Another Young Adult Vampire Romance Novel","War and Pepe","The Fault in our Apple Devices","The Adventures of Blackberry Phone","A Complete History of the Catapult","Eat, Pray, Meme","1983.5","Gone with the Meme","Pomegranates of Wrath","The CATAPULTry Tales",
